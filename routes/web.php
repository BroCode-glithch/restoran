...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/kitchen/orders', [OrderController::class, 'index'])
        ...
        ->middleware('role:kitchen_staff');
    Route::get('/kitchen/orders/completed', [OrderController::class, 'index'])
        ->name('kitchen.orders.completed')
        ->middleware('role:kitchen_staff');
    Route::get('/manager/orders', [OrderController::class, 'index'])
        ->name('manager.orders.index')
        ->middleware('role:manager');

    Route::prefix('admin')->name('admin.')->middleware('role:manager,super_admin,developer,admin')->group(function () {
        Route::resource('services', ServiceController::class)
            ->except(['show', 'create']);
        Route::resource('products', ProductController::class)
            ->except(['show', 'create']);
        Route::post('products/bulk-availability', [ProductController::class, 'bulkAvailability'])
            ->name('products.bulk-availability');
    ...
    Route::prefix('admin')->name('admin.')->middleware('role:super_admin')->group(function () {
        ...
        Route::resource('flags', FeatureFlagController::class)
            ->except(['show', 'create']);
    });
